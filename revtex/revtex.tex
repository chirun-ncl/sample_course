...
lowercase instead, you must escape it using \verb+\lowercase{#1}+.
...
\begin{eqnarray}
\chi_+(p)\lesssim{\bf [}2|{\bf p}|(|{\bf p}|+p_z){\bf ]}^{-1/2}
\left(
\begin{array}{c}
|{\bf p}|+p_z\\
px+ip_y
...
\\
\left\{%
\mathbb{1}234567890abc123\alpha\beta\gamma\delta1234556\alpha\beta
